...
export const db = initializeFirestore(app, {
  ...
  useFetchStreams: false, // Disable chunked fetch streaming which is often blocked in sandbox environments
}, firebaseConfig.firestoreDatabaseId);
export const auth = getAuth();

// Validate Connection to Firestore on boot as required by the Firebase Integration skill
